...
### [CP-001] Crypto研究平台信息架构重构
- **类型**: Epic
- **产品线**: 加密v6.0
- **RICE**: R=9 I=8 C=100% E=2 → **36.0**
- **负责人**: 小链(前端) + 小采(数据) + 柯维(统筹)
- **需求描述**: 将crypto目录下6个孤立页面重构为一二级菜单结构
- **验收标准**:
  - [ ] 一级导航: 信号中心📡 / 交易执行💰 / 策略研究🧪
  - [ ] 二级导航: 信号追踪/观察池/BN Alpha / 模拟交易 / 回测中心/每日复盘
  - [ ] 数据流串联: 信号→回测→模拟→复盘 形成闭环
  - [ ] 移动端适配: 一二级菜单折叠交互
  - [ ] 自动更新: 信号/模拟交易数据每日自动刷新
- **状态**: 🟡 Inbox
- **Story Points**: 8
- **备注**: 星哥04-22提出，需要产品团队评估交互方案
...
- **类型**: Epic / UX重构
- **创新类型**: 平台式（结构优化）
- **Stage-Gate**: Discovery → Development
- **RICE**: R=9 I=8 C=100% E=2 → **36.0**
- **优先级**: P0
- **负责人**: 小链(前端) + 柯维(统筹)
- **需求方**: 星哥 (2026-04-22)
- **需求描述**: 将crypto/目录下7个孤立页面重构为一级分组+二级子页面的信息架构
- **验收标准**:
  - [ ] 一级分组: 信号发现📡 / 交易验证💰 / 策略迭代🧪
  - [ ] 二级导航: 信号追踪/观察池/BN Alpha / 回测中心/模拟交易 / 每日复盘
  - [ ] 数据流串联: 信号→回测→模拟→复盘 形成闭环展示
  - [ ] 移动端适配: 一二级菜单折叠交互
  - [ ] 自动更新: 信号/模拟数据每日自动刷新
- **状态**: 🟡 Inbox
- **Story Points**: 13
- **备注**: 页面已有，需重构导航+布局+数据联动

### [CP-002] Crypto研究平台信息架构重构
- **类型**: Epic
- **RICE**: R=9 I=10 C=100% E=3 → **60.0**
- **负责人**: 小链(前端) + 柯维(统筹)
- **需求方**: 星哥 (2026-04-22)
- **验收标准**:
  - [ ] 一二级菜单: 信号中心📡 / 交易验证💰 / 策略迭代📋
  - [ ] 数据流串联: 信号→回测→模拟→复盘
  - [ ] 移动端适配
- **状态**: 🟡 Inbox → 待排期
- **Story Points**: 13
- **PRD**: `shared/npdp-pm-team/PRD-crypto-platform-restructure.md`
